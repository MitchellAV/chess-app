...
function () {
  ...
  Game.prototype.playerMove = function (player, start, end) {
    var startPiece = this.board.getBoardState()[start.getY()][start.getX()].getPiece();
    ...
    if (startPiece.isValidMove(end)) {
      ...
      this.moveList.push(move); // Castling
      ...
      this.board.updateAllValidMoves();
      startPiece.updateValue(startPiece.getX(), startPiece.getY()); // console.log(this.board.boardState);
