		...
		if (this.isWhitePiece()) {
			if (this.hasMoved == false) {
				if (this.boardState[7][0].getPiece() !== null) {
					if (
						this.boardState[7][0].getPiece()!.hasPieceMoved() ==
						false
					) {
						if (
							this.boardState[7][1].getPiece() == null &&
				...
				if (this.boardState[7][7].getPiece() !== null) {
					if (
						this.boardState[7][7].getPiece()!.hasPieceMoved() ==
						false
					) {
						if (
							this.boardState[7][5].getPiece() == null &&
			...
			if (this.hasMoved == false) {
				if (this.boardState[0][0].getPiece() !== null) {
					if (
						this.boardState[0][0].getPiece()!.hasPieceMoved() ==
						false
					) {
						if (
							this.boardState[0][1].getPiece() == null &&
				...
				if (this.boardState[0][7].getPiece() !== null) {
					if (
						this.boardState[0][7].getPiece()!.hasPieceMoved() ==
						false
					) {
						if (
							this.boardState[0][5].getPiece() == null &&
